...
public class IntensiveCareDoctor extends Doctor implements IntensiveCareStaffMember, Serializable{
	...
	public IntensiveCareDoctor(int id, String firstName, String lastName, Date birthDate, String address,
			String phoneNumber, String email, String gender, Date workStartDate, double salary,String password, int licenseNumber,
			boolean isFinishInternship) {
		super(id, firstName, lastName, birthDate, address, phoneNumber, email, gender, workStartDate, salary, password, licenseNumber,
